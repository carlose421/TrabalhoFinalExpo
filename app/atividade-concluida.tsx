...
export default function AtividadeConcluidaScreen() {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.replace('/(tabs)/inicio')}>
          <Text style={styles.backBtn}>{'<'} Voltar para o início</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.card}>
        <Text style={styles.title}>Detalhes do exercício ({tipo})</Text>
