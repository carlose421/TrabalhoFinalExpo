			...
			{!started ? (
				...
				<>
					...
					<View style={styles.btnRow}>
						<TouchableOpacity style={styles.pauseBtn} onPress={pauseRun}><Text style={styles.pauseBtnText}>Pausar</Text></TouchableOpacity>
						<TouchableOpacity style={styles.finishBtn} onPress={finishRun} activeOpacity={0.7}>
